...
public class weaponBuilder : MonoBehaviour
{
	...
	public string relativePathUsableWeaponPrefab = "Assets/Game Kit Controller/Prefabs/Weapons/Usable Weapons";
...
//				newArmsTransform.SetParent (armsParent);
	...
	public void checkIfCreateInventoryWeapon ()
	{
		if (createWeaponInventoryActive) {
			...
			mainIKWeaponSystem.createInventoryWeaponExternally (weaponName, weaponIconTexture);
		}
	}
	...
	public void checkIfCreateInventoryWeaponAmmo ()
	{
		if (createWeaponAmmoInventoryActive) {
			mainIKWeaponSystem.createInventoryWeaponAmmoExternally ((weaponName + " Ammo"));
		}
	}
