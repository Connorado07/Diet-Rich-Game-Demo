		...
		if (persistanceInfoList != null && persistanceInfoList.Count > 0) {
			...
			for (int k = 0; k < persistanceInfoListCount; k++) {
				...
				if (currentObjectiveEventSystem != null) {
					...
					if (currentPersistanceMissionInfo.missionInProcess) {
					...
					mainObjectiveLogSystem.addObjective (currentPersistanceMissionInfo.objectiveName, currentPersistanceMissionInfo.objectiveDescription, currentPersistanceMissionInfo.objectiveFullDescription, 
						currentPersistanceMissionInfo.objectiveLocation, currentPersistanceMissionInfo.objectiveRewards, null);
