...
public class hideFromEnemiesSystem : MonoBehaviour
{
	...
	[HideInInspector] public Vector3 cubeGizmoScale = Vector3.one;
	[HideInInspector] public Color gizmoLabelColor = Color.white;
	[HideInInspector] public Color linesColor = Color.yellow;
	[HideInInspector] public bool useHandleForVertex;
	[HideInInspector] public float handleRadius = 0.1f;
	...
	[HideInInspector] public string triggerLayer;
	[HideInInspector] public Material triggerMaterial;
	[HideInInspector] public Vector2 newPositionOffset;

	GameObject wallRenderer;
	MeshRenderer mainMeshRenderer;
	[HideInInspector] public List<Transform> vertexPosition = new List<Transform> ();
...
//			}
	...
	public void createTileElement ()
	{
		...
		GKC_Triangulator_Utils tr = new GKC_Triangulator_Utils (vertex2D);
