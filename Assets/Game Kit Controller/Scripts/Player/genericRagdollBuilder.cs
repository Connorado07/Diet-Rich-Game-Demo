...
public class genericRagdollBuilder : MonoBehaviour
{
	...
	public void updateRagdollActivatorParts (bool addingRagdollOnEditorTime)
	{
		if (mainRagdollActivator != null) {
			...
			mainRagdollActivator.addNewExtraRagdollInfo (characterBody, ragdollName, bonesList, rigidbodyList, colliderList, pelvis, rotationYOffset, addingRagdollOnEditorTime);
