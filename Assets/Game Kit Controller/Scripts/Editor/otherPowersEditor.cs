...
public class otherPowersEditor : Editor
{
	...
	SerializedProperty wallWalkActive;
	...
	SerializedProperty wallWalkEnabled;
	SerializedProperty stopGravityAdherenceWhenStopRun;
	SerializedProperty wallWalkRotationSpeed;

	SerializedProperty trailsPrefab;
	SerializedProperty trailsActive;
	SerializedProperty trails;

	SerializedProperty changePlayerMaterialsOnWallRun;
	...
	void OnEnable ()
	{
		...
		wallWalkActive = serializedObject.FindProperty ("wallWalkActive");
		...
		runMat = serializedObject.FindProperty ("settings.runMat");
		...
		wallWalkEnabled = serializedObject.FindProperty ("wallWalkEnabled");
		stopGravityAdherenceWhenStopRun = serializedObject.FindProperty ("stopGravityAdherenceWhenStopRun");
		wallWalkRotationSpeed = serializedObject.FindProperty ("wallWalkRotationSpeed");

		trailsPrefab = serializedObject.FindProperty ("trailsPrefab");
		trailsActive = serializedObject.FindProperty ("settings.trailsActive");
		trails = serializedObject.FindProperty ("trails");
		changePlayerMaterialsOnWallRun = serializedObject.FindProperty ("settings.changePlayerMaterialsOnWallRun");
	...
	public override void OnInspectorGUI ()
	{
		...
		GUILayout.Label ("Wall Walk Active\t\t" + wallWalkActive.boolValue);
		...
		if (showSettings.boolValue) {
			...
			EditorGUILayout.PropertyField (runMat, new GUIContent ("Run Material"), false);
			...
			GUILayout.BeginVertical ("Wall Run Power Settings", "window");
			EditorGUILayout.PropertyField (wallWalkEnabled);
			if (wallWalkEnabled.boolValue) {
				EditorGUILayout.PropertyField (stopGravityAdherenceWhenStopRun);
				EditorGUILayout.PropertyField (wallWalkRotationSpeed);
			}
			EditorGUILayout.PropertyField (trailsPrefab);
			EditorGUILayout.PropertyField (trailsActive);
			if (trailsActive.boolValue) {
				showTrailsList (trails);
			}
			EditorGUILayout.PropertyField (changePlayerMaterialsOnWallRun);
