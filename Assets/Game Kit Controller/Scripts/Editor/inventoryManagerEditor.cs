...
//		}
	...
	void showInventoryListElementInfo (SerializedProperty list, bool expanded, int index)
	{
		...
		if (list.FindPropertyRelative ("isWeapon").boolValue) {
			EditorGUILayout.PropertyField (list.FindPropertyRelative ("mainWeaponObjectInfo"));
		}
	...
	{
		GUILayout.BeginVertical ();
		EditorGUILayout.PropertyField (list, new GUIContent ("Initial Inventory List"), false);
		if (list.isExpanded) {
