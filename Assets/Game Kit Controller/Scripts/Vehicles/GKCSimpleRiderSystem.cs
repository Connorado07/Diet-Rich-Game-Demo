...
public class GKCSimpleRiderSystem : MonoBehaviour
{
	...
	public void startOrStopVehicle (bool state)
	{
        ...
        //the player gets off from the vehicle
			...
			targetRotation = currentPassengerComponents.playerGravityManager.getCurrentNormal () *
			currentRiderGameObject.transform.InverseTransformPoint (targetRotation).y;
